  ...
  useEffect(() => {
    ...
    const markMessagesAsRead = useCallback(async () => {
          ...
          try {
            ...
            await axios.post(`${API_BASE_URL}/message/admin/mark-read/${userId}`);
          } catch (err) {
        ...
        const fetchMessages = async () => {
          ...
          try {
            const response = await axios.get(`${API_BASE_URL}/message/admin/${userId}`);
  ...
  return (
    ...
    >
      <Toolbar>
        ...
        <Button onClick={() => setChatOpen(true)} sx={{ color: '#fff', ml: 2 }}>
  Chat
</Button>
