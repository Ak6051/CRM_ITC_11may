...
import SalesChatBox from '../../pages/sales pages/SalesChatBox';
...
const SalesNavbar = () => {
    ...
    return (
        ...
        >
            <Toolbar>
                <Typography variant="h6" sx={{ flexGrow: 1, fontWeight: 'bold', color: '#ffcc00' }}>
                    Sales Dashboard
                </Typography>
                ...
                <SalesChatBox open={chatOpen} handleClose={() => setChatOpen(false)} senderId={sessionStorage.getItem("userId")} />
                ...
                <Menu
                    ...
                    onClose={handleClose}
                    sx={{ '& .MuiPaper-root': { backgroundColor: '#2c2c3e', color: '#ffffff' } }}
                >
                    <MenuItem onClick={() => { handleClose(); navigate('/sales-profile'); }}>My Profile</MenuItem>
