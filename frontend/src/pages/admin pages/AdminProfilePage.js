...
import {
  ...
  Home as HomeIcon, Badge as BadgeIcon,
  Wc as GenderIcon, Save as SaveIcon,
...
const ProfilePage = () => {
  const [user, setUser] = useState({
    ...
    mobileNo: '', address: '', gender: '', designation: '',
  });
  ...
  const fields = [
    ...
    { name: 'designation', label: 'Designation',  icon: <BadgeIcon />,   xs: 6 },
                  ...
                  <Box sx={{ display: 'flex', gap: 1, mt: 1, flexWrap: 'wrap' }}>
                    {user.designation && (
                      <Chip label={user.designation} size="small"
                        sx={{ bgcolor: 'rgba(255,255,255,0.2)', color: '#fff', fontWeight: 600, fontSize: 12 }} />
                    )}
                    <Chip label="Admin" size="small"
                      sx={{ bgcolor: 'rgba(255,215,0,0.25)', color: '#FFD700', fontWeight: 700, fontSize: 12 }} />
                  </Box>
                </Box>
              </Box>
