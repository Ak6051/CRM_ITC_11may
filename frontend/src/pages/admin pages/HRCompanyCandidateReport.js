...
const HRCompanyCandidateReport = () => {
  ...
  const candidateColumns = [
    ...
    { field: '_experience',     headerName: 'Experience (Years)',      width: 140 },
    { field: '_location',       headerName: 'Location',        width: 130 },
    { field: '_currentCTC',     headerName: 'Current Monthly ₹',     width: 140 },
    { field: '_expectedCTC',    headerName: 'Expected Monthly ₹',    width: 140 },
    { field: '_noticePeriod',   headerName: 'Notice Period (Days)',   width: 150 },
