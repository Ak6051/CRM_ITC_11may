...
>
  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
    <Button variant="contained" onClick={() => { setEditData(null); setOpenForm(true); }} disabled={!canDo('tl-sales-daily-task-report:create')}>
      + Create Task
    </Button>
      ...
      <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
        ...
        <LocalizationProvider dateAdapter={AdapterDateFns}>
          ...
          <Button
            ...
            onClick={handleExport} disabled={!canDo('tl-sales-daily-task-report:export')}
